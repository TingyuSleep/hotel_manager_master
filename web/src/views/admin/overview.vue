      ...
      <a-row :gutter="[20, 20]">
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="房间总数">
            ...
            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ tdata.data.spzs }}<span class="v-e">间</span></span>
              </div>
              <div class="box-bottom">
                <span>今日入住 {{ tdata.data.qrxz }} 间</span>
              </div>
            </div>
          </a-card>
        </a-col>
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="今日合计销售额">
            <template #extra>
              <a-tag color="green" slot="extra">销售额</a-tag>
            </template>

            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ tdata.data.alldd }}<span class="v-e">单</span></span>
              </div>
              <div class="box-bottom">
                <span>共 {{ tdata.data.allmoney }} 元</span>
              </div>
            </div>
          </a-card>
        </a-col>
