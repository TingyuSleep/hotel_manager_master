            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="窗户">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.windows">
              ...
              <a-col span="12">
                <a-form-item label="状态" name="status">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.status">
                    <a-select-option key="0" value="0">未入住</a-select-option>
                    <a-select-option key="1" value="1">已入住</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
...
<script setup lang="ts">
  ...
  const columns = reactive([
    ...
    },
    {
      ...
      dataIndex: 'status',
      key: 'status',
      customRender: ({ text, record, index, column }) => (text === '0' ? '未入住' : '已入住'),
    },
  ]);
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        if (modal.form.windows) {
          formData.append('windows', modal.form.windows);
        }
